...
<div class="content">
    <c:url value="/user/${user.id}" var="user_url"/>
    <form:form action="${user_url}" method="PUT" id="changePasswordUser" commandName="user">
        ...
        <div class="form-button">
            <div class="buttonWrapper">
                <a href="<c:url value='/dashboard'/>" class="back">Kembali</a>
            </div>
