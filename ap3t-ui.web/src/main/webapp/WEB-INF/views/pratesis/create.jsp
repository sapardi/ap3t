...
<div class="content">
    ...
    <form:form action="${pratesis_url}" method="POST" modelAttribute="pratesis" id="pratesisForm">
        <div class="blocksection">
            <div class="blockcontent">
                <h3>Insert New Pratesis </h3>
        ...
        <div class="form-button">
            <div class="buttonWrapper">
                <a href="<c:url value='/pratesis'/>" class="back">Back</a>
            </div>
