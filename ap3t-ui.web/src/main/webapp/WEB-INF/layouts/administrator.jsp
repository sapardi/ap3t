...
<head>
    <title>Aplikasi Pengajuan dan Penilaian Proposal dan Tesis</title>
...
<div id="bodyout">
    <div class="container">
        <div id="header">
            <h1><a href="#">Aplikasi Pengajuan dan Penilaian Proposal dan Tesis</a></h1>
            <tiles:insertAttribute name="mainNav" ignore="true"/>
            <tiles:insertAttribute name="secNav" ignore="true"/>
        </div>
        <div id="wrapper">
            <div id="contentwrap">
                <%-- <div id="breadcrumb">
                ...
                <div id="page-title">
                    <h1 class="icon gear"><span>Aplikasi Pengajuan dan Penilaian </span>Proposal dan Tesis</h1>
                    <%--<a href="#" class="buttonlink blue shadow">Buy</a>
                    <a href="#" class="buttonlink arrow shadow">Download</a>--%>
...
<div id="footerout">
    <div class="container">
        <div id="footer">
            ...
            <div id="copyright">
                &copy; Copyright 2011 <a href="http://www.jasoet.com">Jasoet Inc.</a>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
